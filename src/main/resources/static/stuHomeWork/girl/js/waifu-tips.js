...
var user_name='';
$(function () {
    user_name=$('#user_name_a').attr('value');
})
console.log(re);
...
function showHitokoto(){
    $.getJSON('//api.fghrsh.net/hitokoto/rand/?encode=jsc&uid=3335',function(result){
        var text = '我超级喜欢 <span style="color:#0099cc;">『1107』</span>啊!，这应该 <span style="color:#0099cc;">不会变吧!</span> 对呢！' +new Date()+ '记!';
...
var waifuJson = {
    "mouseover": [
        ...
        {
            "selector": "#green_channel #green_channel_digg",
            "text": ["觉的我家主人的文章有帮助的话，可以分享给更多需要的朋友呢"]
        },
        {
            "selector": "#green_channel #green_channel_follow",
            "text": ["觉得我可爱的话~关注我家主人吧！mua~"]
        },
        {
            "selector": "#green_channel #green_channel_favorite",
            "text": ["要收藏吗？"]
        },
        {
            "selector": "#green_channel #green_channel_weibo img",
            "text": ["喜欢文章的可以分享到微博呢。"]
        },
        {
            "selector": "#green_channel #green_channel_wechat img",
            "text": ["转载前要先注意下文章的 版权协议 呢"]
        },
        {
            "selector": "#tbCommentBody",
            "text": ["想要评论些什么吗？我家主人会看的哦，认真填写呢~"]
        },
        {
        ...
        {
            "selector": ".topicListFooter #nav_next_page ",
            "text": ["去下一页看看吧~"]
        },
        {
        ...
        {
            "selector": "#video-btn button",
            "text": ["这里有我家主人的秘密呢，要不要看看呢？"]
        },
        {
...
function loadOtherModel(){
    ...
    $.ajax({
        ...
        success: function (result){
            ...
            showMessage(result.model['message'], 1000, true);
        }
    });
}

...
$(function(){
    ...
    $(".king").suspensionTips({"content": "2202クラスの頂点に立つ強者", position:"right"});
    $(".diamond").suspensionTips({"content": "頂点に次ぐ強者", position:"right"});
    $(".platinum").suspensionTips({"content": "注目のプログラマー", position:"right"});
    $(".gold").suspensionTips({"content": "千載一遇のプログラマー", position:"right"});
    $(".sliver").suspensionTips({"content": "頑張れ少年~", position:"right"});
    $(".bronze").suspensionTips({"content": "駆け出しの怠け者", position:"right"});
    $("#img1").suspensionTips({"content": "这是出现在上方的提示信息。", position:"top"});
    $("#img2").suspensionTips({"content": "这是出现在右方的提示信息。", position:"right"});
    $("#img3").suspensionTips({"content": "这是出现在下方的提示信息。", position:"bottom"});
